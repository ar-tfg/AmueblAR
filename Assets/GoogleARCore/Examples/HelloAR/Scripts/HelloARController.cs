...
namespace GoogleARCore.Examples.HelloAR
{
    ...
    enum Phase { Display, Rotate, Build };
    ...
    public class HelloARController : MonoBehaviour
    {
        ...
        /// <summary>
        /// The necessary UI and furniture for the use of the application
        /// </summary>
        ...
        public Button AnimateForward;
        public Button AnimateBackward;
        //public Button Finish; //Gets back to the furniture selection menu

        private Phase currentPhase; //Starts at display phase
        ...
        //Sets the buttons and objects for each phase
        private void CheckPhase() {
            if (currentPhase == Phase.Display)
            {
                ...
                AnimateForward.gameObject.SetActive(false);
                AnimateBackward.gameObject.SetActive(false);
            ...
            else if (currentPhase == Phase.Rotate)
            {
                ...
                RotateRight.gameObject.SetActive(false);
                RotateLeft.gameObject.SetActive(false);
                AnimateForward.gameObject.SetActive(true);
                AnimateBackward.gameObject.SetActive(true);
